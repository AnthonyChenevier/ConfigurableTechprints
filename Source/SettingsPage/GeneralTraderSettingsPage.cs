...
namespace ConfigurableTechprints.SettingsPage
{
    internal class GeneralTraderSettingsPage: ConfigurableTechprintsSettingPage
    {
        protected override void DoPage(Listing_Standard list, Rect inRect)
        {
            ...
            list.SliderWithTextField(ref settings.NativeCommonalityMultiplier, ref ncmStringBuffer, 0.1f, 10f,
                                     tooltip: "NativeCommonalityMultiplier_Tooltip".Translate());
            list.Gap();
            list.Label("TechEqualCommonalityMultiplier_Label".Translate());
            list.SliderWithTextField(ref settings.TechEqualCommonalityMultiplier, ref tleStringBuffer, 1f, 10f,
                                     tooltip: "TechEqualCommonalityMultiplier_Tooltip".Translate());
            list.Gap();
            list.Label("TechDifferenceCommonalityMultiplier_Label".Translate());
            list.SliderWithTextField(ref settings.TechDifferenceCommonalityMultiplier, ref tldStringBuffer, 0.01f, 0.2f,
            ...
            list.SliderWithTextField(ref settings.TraderStockCountMultiplier, ref tsmStringBuffer, 1f, 10f,
                                     tooltip: "TraderStockCountMultiplier_Tooltip".Translate());
            list.GapLine();
            ...
            foreach (TraderKindDef trader in traderKindDefs)
            {
                ...
                list.CheckboxLabeled($"{traderDefName}: '{trader.LabelCap}': ", ref ignoreThis, 
                                     tooltip:$"IgnoredTrader_Tooltip".Translate());
                if (ignoreThis)
                {
